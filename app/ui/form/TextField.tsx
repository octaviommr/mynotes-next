  ...
  return (
    <Field className="group" disabled={disabled}>
      ...
      <Input
        ...
        className={clsx(
          "mt-1 block w-full rounded-lg border border-solid bg-[var(--background)] px-3 py-1.5 text-sm/6 data-[disabled]:border-opacity-50 data-[disabled]:bg-[#f2f2f2] dark:data-[disabled]:bg-[#1a1a1a]",
          {
